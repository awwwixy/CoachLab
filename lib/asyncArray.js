// Лабораторна 5: асинхронні варіанти функції map

// 1) Callback-based: обробляє елементи по черзі, у кінці викликає done(err, result)
...
// 2) Promise-based: повертає Promise з масивом результатів.
// Підтримує скасування через signal (AbortController).
